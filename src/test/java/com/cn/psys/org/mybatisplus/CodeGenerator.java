    ...
    public void autoMade(){
        {
            ...
            dsc.setUrl("jdbc:mysql://127.0.0.1:3306/my_test?useUnicode=true&characterEncoding=utf8&allowMultiQueries=true");
...
//        mpg.setDataSource(dsc);
        ...
        */
            ...
            focList.add(new FileOutConfig(templatePath) {
                ...
                public String outputFile(TableInfo tableInfo) {
                    // 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发生变化！！
                    return projectPath + "/src/main/java/com/cn/psys/" + pc.getModuleName()+"/controller"
