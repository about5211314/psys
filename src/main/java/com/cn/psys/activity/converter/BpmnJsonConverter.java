 ...
 */
package com.cn.psys.activity.converter;
...
public class BpmnJsonConverter implements EditorJsonConstants, StencilConstants, ActivityProcessor {
    ...
    @Override
    public void processFlowElements(FlowElementsContainer flowElementsContainer, BpmnModel bpmnModel, ArrayNode arrayNode, Map<String, ModelInfo> map, Map<String, ModelInfo> map1, double v, double v1) {

    }

    @Override
    public void processJsonElements(JsonNode jsonNode, JsonNode jsonNode1, BaseElement baseElement, Map<String, JsonNode> map, Map<String, String> map1, Map<String, String> map2, BpmnModel bpmnModel) {
