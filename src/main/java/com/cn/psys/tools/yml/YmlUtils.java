...
public class YmlUtils {
    ...
    private static String bootstrap_file = "classpath:application-jdbc.yml";
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Map<String, String> ymlByFileName = getYmlByFileName(bootstrap_file,"spring", "datasource","url");
